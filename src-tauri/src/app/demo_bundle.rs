...
const DEMO_TEMPLATE_APP_JS: &str = concat!(
    ...
    include_str!("../demo-template/js/media/pipeline/recording-loop.js"),
    ...
    include_str!("../demo-template/js/media/pipeline/capture-worker.js"),
    "\n",
    ...
    "\n",
    include_str!("../demo-template/js/vm/hierarchy/inspection-map.js"),
    "\n",
    ...
    "\n",
    include_str!("../demo-template/js/vm/observer/hot-set.js"),
    "\n",
    include_str!("../demo-template/js/vm/observer/watch-set.js"),
    "\n",
    ...
    "\n",
    include_str!("../demo-template/js/core/bridge/render-surface-lifecycle.js"),
    "\n",
