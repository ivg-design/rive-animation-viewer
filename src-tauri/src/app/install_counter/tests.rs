...
#[test]
fn consent_creates_random_state_and_opt_out_removes_linkable_values_without_losing_deduplication() {
    let mut state = CounterState::default();
    apply_consent(&mut state, true);
