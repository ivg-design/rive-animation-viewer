...
const globalBindingsController = createGlobalBindingsController({
    callbacks: {
        ...
        getLiveConfigState,
        getSidebarVisibility: () => shellController?.getSidebarVisibility?.() ?? { left: false, right: true },
        ...
        setEditorCode,
        setLiveConfigSource,
        setSidebarVisibility: (visibility) => shellController?.setSidebarVisibility?.(visibility) ?? { left: false, right: true },
        setVmExplorerSnippetEnabled,
        showMcpSetup,
        switchArtboard,
