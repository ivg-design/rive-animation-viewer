export const CORE_TOOLS = [
  ...
  },
  {
    ...
    description:
      'Set explicit canvas pixel sizing. Use mode "fixed" with width/height for a pinned canvas, or mode "auto" to follow the viewer size.',
    inputSchema: {
      type: 'object',
      properties: {
        mode: {
          type: 'string',
          enum: ['auto', 'fixed'],
          description: 'Canvas sizing mode. Defaults to "fixed".',
        },
        width: {
          type: 'number',
          description: 'Explicit canvas width in pixels when mode is "fixed".',
        },
        height: {
          type: 'number',
          description: 'Explicit canvas height in pixels when mode is "fixed".',
        },
        lockAspectRatio: {
          type: 'boolean',
          description: 'Whether width/height updates should preserve aspect ratio.',
        },
      },
      additionalProperties: false,
    },
